    ...
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <div class="w-full overflow-hidden px-4 py-3 mt-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                <form id="form" action="{{ route($route . 'update', $category) }}" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="title" name="title" placeholder="Title" required value="{{ $category->title ?? '' }}"
                    ...
                    <div class="mb-4">
                        ...
                        <select id="type" name="type" required data-placeholder="Choose"
                            ...
                            @forelse($types as $type)
                                ...
                                <option value="{{ $type }}" @selected($type === ($category->$type ?? ''))>{{ str($type)->title() }}</option>
