        ...
        <ul>
            <li class="relative px-6 py-3">
                <button
                    ...
                    @click="toggleBlogMenu" aria-haspopup="true">
                ...
                <template x-if="isBlogMenuOpen">
                    <ul
                        ...
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            <a class="w-full" href="{{ route('admin.blog.post.index') }}">Post</a>
                        </li>
                        <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                            <a class="w-full" href="{{ route('admin.blog.post.comment.report.index') }}">Report Comment</a>
                        </li>
                    </ul>
                </template>
            </li>
